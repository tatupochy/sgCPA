...
from . import views
from .views import (CustomLoginView, LogoutView, users_view, user_detail_view, user_edit_view, user_create_view, user_create_by_person_view,
                    user_delete_view, person_create_view, person_detail_view, persons_view, person_edit_view, person_delete_view,
...
urlpatterns = [
    ...
    path('accounts/users/create_by_person/<int:pk>', user_create_by_person_view, name='user_create_by_person'),
    ...
    path('accounts/persons/<int:pk>/delete/', person_delete_view, name='person_delete'),
